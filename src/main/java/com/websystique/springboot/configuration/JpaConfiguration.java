...
@Configuration
@EnableJpaRepositories(basePackages = "pl.stefan.springboot.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan("pl.stefan.springboot.model");
    ...
    private Properties jpaProperties() {
        ...
        properties.put("hibernate.format_sql", environment.getRequiredProperty("datasouce.sampleapp.hibernate.format_sql"));
